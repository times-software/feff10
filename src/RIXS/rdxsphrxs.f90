...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      subroutine rdxsphrxs ( ne, ne1, ne3, nph, ihole, rnrmav,xmu,edge,    &
     &               ik0, em, eref, iz, potlbl, ph, rkk, lmax, lmaxp1, fname)
...
!     ne3  - number of points on auxilary horizontal axis (need for f')
!     xmu  - Fermi energy
...
!     use temp to write ph, rkk, since ne < nex
      ...
      !call chopen (ios, fname, 'rdxsphrxs')
