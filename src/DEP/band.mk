...
./BAND/bandtot.f90 ./BAND/ibravais.f90 ./COMMON/rdxsph.f90 \
./COMMON/padlib.f90 ./FMS/kprep.f90 ./MATH/cwig3j.f90 \
...
./KSPACE/makerotations.f90 ./BAND/kpath.f90 ./MATH/terp.f90 \
./MATH/polint.f90 ./BAND/fmsband.f90 ./BAND/kkrband.f90 \
./KSPACE/structurefactor.f90 ./KSPACE/strset.f90 ./KSPACE/strbbdd2.f90 \
./KSPACE/strbbdd.f90 ./FMS/kkrintegral.f90 ./COMMON/writematrix.f90 \
./BAND/bandblaslapack.f90 ./RDINP/rdline.f90 ./COMMON/nxtunt.f90 
band_MODULESRC = \
