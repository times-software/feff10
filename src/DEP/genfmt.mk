...
./GENFMT/xstar.f90 ./COMMON/rdxsph.f90 ./COMMON/padlib.f90 \
./GENFMT/rdpath.f90 ./MATH/dist.f90 ./COMMON/iniptz.f90 \
./COMMON/head.f90 ./GENFMT/snlm.f90 ./GENFMT/setlam.f90 \
./GENFMT/rot3i.f90 ./GENFMT/mmtr.f90 ./MATH/bcoef.f90 \
./MATH/rotwig.f90 ./GENFMT/sclmz.f90 ./GENFMT/fmtrxi.f90 \
./GENFMT/mmtrxi.f90 ./MATH/trap.f90 ./COMMON/pijump.f90 \
./GENFMT/genfmtjas.f90 ./COMMON/rdxsphjas.f90 ./GENFMT/mmtrjas.f90 \
./XSPH/bcoefjas.f90 ./GENFMT/mmtrjas0.f90 ./GENFMT/mmtrxijas.f90 \
