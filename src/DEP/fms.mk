...
./KSPACE/kmesh.f90 ./COMMON/rdhead.f90 ./COMMON/setkap.f90 \
./FMS/fmstot.f90 ./COMMON/rdxsphjas.f90 ./COMMON/padlib.f90 \
./COMMON/rdxsph.f90 ./COMMON/rdxsph_h.f90 ./FMS/kprep.f90 \
./MATH/cwig3j.f90 ./KSPACE/calccgc.f90 ./KSPACE/strinit.f90 \
...
./KSPACE/bastrans.f90 ./KSPACE/makerotations.f90 ./FMS/xprep.f90 \
./FMS/xstaff.f90 ./DEBYE/sigms.f90 ./MATH/dist.f90 \
./COMMON/pertab.f90 ./DEBYE/sigrem.f90 ./COMMON/itoken.f90 \
./DEBYE/sigcl.f90 ./RDINP/rdline.f90 ./COMMON/nxtunt.f90 \
...
./KSPACE/strbbdd.f90 ./FMS/fmspack.f90 ./MATH/besjh.f90 \
./MATH/bjnser.f90 ./MATH/ylm.f90 ./FMS/gglu.f90 \
./FMS/ggbi.f90 ./FMS/ggrm.f90 ./FMS/gggm.f90 \
./FMS/ggtf.f90 ./FMS/fmspack_h.f90 ./FMS/gglu_h.f90 
fms_MODULESRC = \
