screenwSRC = \
./DYNSCREEN3/screenw.f90 ./PAR/par.f90 ./COMMON/wlog.f90 \
./COMMON/str.f90 ./COMMON/chopen.f90 ./SCREEN/rdgeom.f90 \
./COMMON/rdhead.f90 ./SCREEN/frgrid.f90 ./DYNSCREEN3/prepw.f90 \
...
./MATH/phamp.f90 ./MATH/exjlnl.f90 ./DYNSCREEN3/screenwsub.f90 \
...
./SCREEN/fxc.f90 ./SCREEN/fegrid.f90 DYNSCREEN3/diag_lapack.f90
screenw_MODULESRC = \
...
./FMS/m_fms.f90 ./ERRORMODS/m_errorfile.f90 DYNSCREEN3/diag_mods.f90
