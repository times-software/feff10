...
./KSPACE/makerotations.f90 ./COMMON/rdhead.f90 ./ATOM/apot.f90 \
./RDINP/setedg.f90 ./POT/moveh.f90 ./ATOM/scfdat.f90 \
./ATOM/dsordf.f90 ./ATOM/aprdev.f90 ./ATOM/inmuat.f90 \
./COMMON/getorb.f90 ./RDINP/rdline.f90 ./COMMON/nxtunt.f90 \
./ATOM/wfirdf.f90 ./ATOM/dentfa.f90 ./ATOM/nucdev.f90 \
...
./COMMON/xx.f90 ./POT/frnrm.f90 ./MATH/somm2.f90 \
./COMMON/setgam.f90 ./MATH/terp.f90 ./MATH/polint.f90 \
./COMMON/padlib.f90 
atomic_MODULESRC = \
