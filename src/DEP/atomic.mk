atomicSRC = \
./ATOM/atomic.f90 ./PAR/par.f90 ./COMMON/wlog.f90 \
...
./COMMON/rdhead.f90 ./ATOM/apot.f90 ./RDINP/setedg.f90 \
./POT/moveh.f90 ./ATOM/scfdat.f90 ./ATOM/dsordf.f90 \
./ATOM/aprdev.f90 ./ATOM/inmuat.f90 ./COMMON/getorb.f90 \
./RDINP/rdline.f90 ./COMMON/nxtunt.f90 ./ATOM/wfirdf.f90 \
./ATOM/dentfa.f90 ./ATOM/nucdev.f90 ./ATOM/nucmass.f90 \
./ATOM/soldir.f90 ./ATOM/intdir.f90 ./ATOM/messer.f90 \
./ATOM/muatco.f90 ./ATOM/ortdat.f90 ./ATOM/lagdat.f90 \
./ATOM/akeato.f90 ./ATOM/fdrirk.f90 ./ATOM/yzkrdf.f90 \
./ATOM/yzkteg.f90 ./ATOM/potrdf.f90 ./ATOM/vlda.f90 \
./EXCH/vbh.f90 ./EXCH/edp.f90 ./ATOM/cofcon.f90 \
./ATOM/tabrat.f90 ./ATOM/etotal.f90 ./ATOM/fdmocc.f90 \
./ATOM/bkmrdf.f90 ./MATH/somm.f90 ./ATOM/potslw.f90 \
./ATOM/fpf0.f90 ./ATOM/s02at.f90 ./MATH/determ.f90 \
./COMMON/xx.f90 ./MATH/terp.f90 ./MATH/polint.f90 \
./POT/ovrlp.f90 ./MATH/dist.f90 ./POT/sumax.f90 \
./POT/frnrm.f90 ./MATH/somm2.f90 ./COMMON/setgam.f90 \
./COMMON/padlib.f90 
atomic_MODULESRC = \
