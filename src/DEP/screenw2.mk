...
./COMMON/rdhead.f90 ./DYNSCREEN/rdscreen.f90 ./SCREEN/frgrid.f90 \
./DYNSCREEN/prepw2.f90 ./COMMON/rdpot.f90 ./COMMON/padlib.f90 \
./SCREEN/fegrid.f90 ./FMS/yprep.f90 ./FMS/xstaff.f90 \
...
./DYNSCREEN/diag_lapack.f90 ./MATH/lu.f90 ./MATH/seigen.f90 \
...
./COMMON/m_xstruc.f90 ./COMMON/m_t3j.f90 ./COMMON/m_afctr.f90 \
./COMMON/m_ifuns.f90 ./COMMON/m_config.f90 ./DYNSCREEN/diag_mods.f90 \
./ERRORMODS/m_errormod.f90 ./IOMODS/m_iofiles.f90 ./IOMODS/m_padio.f90 \
./IOMODS/m_iomod.f90 ./FMS/m_fms.f90 ./ERRORMODS/m_errorfile.f90 
