...
./BAND/kpath.f90 ./MATH/terp.f90 ./MATH/polint.f90 \
./BAND/fmsband.f90 ./BAND/kkrband.f90 ./KSPACE/structurefactor.f90 \
./KSPACE/strset.f90 ./KSPACE/strbbdd2.f90 ./KSPACE/strbbdd.f90 \
./FMS/kkrintegral.f90 ./COMMON/writematrix.f90 ./BAND/bandblaslapack.f90 \
