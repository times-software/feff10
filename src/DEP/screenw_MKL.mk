screenwSRC = \
./DYNSCREEN/screenw.f90 ./PAR/par.f90 ./COMMON/wlog.f90 \
./COMMON/str.f90 ./COMMON/chopen.f90 ./SCREEN/rdgeom.f90 \
./COMMON/rdhead.f90 ./SCREEN/frgrid.f90 ./DYNSCREEN/prepw.f90 \
...
./MATH/phamp.f90 ./MATH/exjlnl.f90 ./DYNSCREEN/screenwsub.f90 \
./MATH/seigen.f90 ./COMMON/setkap.f90 ./FMS/yprep.f90 \
./FMS/xstaff.f90 ./FMS/fmspack.f90 ./MATH/ylm.f90 \
./FMS/gglu.f90 ./FMS/ggbi.f90 ./FMS/ggrm.f90 \
./FMS/gggm.f90 ./FMS/ggtf.f90 ./SCREEN/fxc.f90 
screenw_MODULESRC = \
