ldosSRC = \
./LDOS/ldos.f90 ./PAR/parallel.f90 ./COMMON/wlog.f90 \
./COMMON/str.f90 ./COMMON/chopen.f90 ./LDOS/reldos.f90 \
...
./COMMON/rdhead.f90 ./LDOS/ldos_driver.f90 ./COMMON/rdpot.f90 \
./COMMON/padlib.f90 ./POT/istprm.f90 ./MATH/dist.f90 \
./POT/sidx.f90 ./COMMON/xx.f90 ./EXCH/vbh.f90 \
./EXCH/edp.f90 ./POT/movrlp.f90 ./MATH/lu.f90 \
./MATH/seigen.f90 ./POT/ovp2mt.f90 ./MATH/terp.f90 \
./MATH/polint.f90 ./MATH/somm2.f90 ./POT/fermi.f90 \
./LDOS/ldossub.f90 ./FMS/kprep.f90 ./MATH/cwig3j.f90 \
...
./KSPACE/bastrans.f90 ./KSPACE/makerotations.f90 ./COMMON/fixvar.f90 \
./COMMON/fixdsx.f90 ./LDOS/rhol.f90 ./FOVRG/dfovrg.f90 \
