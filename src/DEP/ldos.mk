ldosSRC = \
./LDOS/ldos.f90 ./PAR/par.f90 ./COMMON/wlog.f90 \
./COMMON/str.f90 ./COMMON/str2dp.f90 ./COMMON/chopen.f90 \
./LDOS/reldos.f90 ./KSPACE/crystalstructure.f90 ./KSPACE/readcrystaldata.f90 \
...
./KSPACE/kmesh.f90 ./COMMON/rdhead.f90 ./LDOS/ldos_driver.f90 \
./COMMON/rdpot.f90 ./COMMON/padlib.f90 ./POT/istprm.f90 \
./MATH/dist.f90 ./POT/sidx.f90 ./COMMON/xx.f90 \
./EXCH/vbh.f90 ./EXCH/edp.f90 ./POT/movrlp.f90 \
./MATH/lu.f90 ./MATH/seigen.f90 ./POT/ovp2mt.f90 \
./MATH/terp.f90 ./MATH/polint.f90 ./MATH/somm2.f90 \
./POT/fermi.f90 ./LDOS/ldossub.f90 ./FMS/kprep.f90 \
./MATH/cwig3j.f90 ./KSPACE/calccgc.f90 ./KSPACE/strinit.f90 \
./KSPACE/strvecgen.f90 ./KSPACE/strgaunt.f90 ./KSPACE/cgcrac.f90 \
./KSPACE/strsmat.f90 ./KSPACE/straa.f90 ./KSPACE/strconfra.f90 \
...
./COMMON/fixvar.f90 ./COMMON/fixdsx.f90 ./LDOS/rhol.f90 \
...
./MATH/phamp.f90 ./MATH/exjlnl.f90 ./MATH/csomm2.f90 \
./LDOS/fmsdos.f90 ./FMS/yprep.f90 ./FMS/xstaff.f90 \
...
./FMS/gggm.f90 ./FMS/ggtf.f90 ./LDOS/ff2rho.f90 \
./LDOS/ldossub_h_unrolled.f90 ./LDOS/rhol_h_step1.f90 ./LDOS/fmsdos_h_step1.f90 \
./LDOS/ff2rho_h_step1.f90 ./MATH/trap.f90 ./LDOS/rhol_h_step2.f90 \
./LDOS/fmsdos_h_step2.f90 ./FMS/fmspack_h.f90 ./FMS/gglu_h.f90 \
./LDOS/ff2rho_h_step2.f90 
ldos_MODULESRC = \
...
./COMMON/m_t3j.f90 ./ERRORMODS/m_errorfile.f90 
