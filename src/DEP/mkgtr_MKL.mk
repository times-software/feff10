...
./MKGTR/getgtrjas.f90 ./COMMON/rdxsphjas.f90 ./COMMON/padlib.f90 \
./MATH/cpl0.f90 ./XSPH/bcoefjas.f90 ./MATH/cwig3j.f90 \
./MKGTR/calclbcoef.f90 ./MKGTR/rotgmatrix.f90 ./MATH/rotwig.f90 \
./RDINP/rdline.f90 ./COMMON/nxtunt.f90 ./MKGTR/getgtr.f90 \
./COMMON/rdxsph.f90 ./COMMON/iniptz.f90 ./MATH/bcoef.f90 
mkgtr_MODULESRC = \
...
./IOMODS/m_iomod.f90 ./ERRORMODS/m_errorfile.f90 
