...
./MATH/cpl0.f90 ./PATH/paths.f90 ./MATH/sdist.f90 \
./PATH/sortix.f90 ./PATH/ccrit.f90 ./PATH/mrb.f90 \
./PATH/mcrith.f90 ./PATH/mcritk.f90 ./PATH/ipack.f90 \
./PATH/heap.f90 ./PATH/pathsd.f90 ./PATH/timrep.f90 \
./PATH/mpprmp.f90 ./PATH/phash.f90 ./PATH/outcrt.f90 \
./MATH/strap.f90 ./PATH/mpprmd.f90 
path_MODULESRC = \
...
./COMMON/m_nrixs.f90 ./ERRORMODS/m_errorfile.f90 
