crpaSRC = \
./CRPA/crpa.f90 ./PAR/par.f90 ./COMMON/wlog.f90 \
./COMMON/str.f90 ./COMMON/str2dp.f90 ./COMMON/chopen.f90 \
./SCREEN/rdgeom.f90 ./COMMON/rdhead.f90 ./SCREEN/frgrid.f90 \
./SCREEN/prep.f90 ./COMMON/rdpot.f90 ./COMMON/padlib.f90 \
./SCREEN/fegrid.f90 ./COMMON/fixvar.f90 ./MATH/terp.f90 \
./MATH/polint.f90 ./COMMON/fixdsx.f90 ./SCREEN/getph.f90 \
...
./CRPA/chi_crpa.f90 ./MATH/seigen.f90 ./COMMON/setkap.f90 \
