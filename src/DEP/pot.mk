...
./KSPACE/makerotations.f90 ./COMMON/rdhead.f90 ./POT/potsub.f90 \
./POT/inipot.f90 ./POT/moveh.f90 ./POT/istprm.f90 \
...
./MATH/somm2.f90 ./POT/fermi.f90 ./POT/afolp.f90 \
./POT/corval.f90 ./COMMON/fixvar.f90 ./COMMON/fixdsx.f90 \
./POT/rholie.f90 ./FOVRG/dfovrg.f90 ./FOVRG/inmuac.f90 \
