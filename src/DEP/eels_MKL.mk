...
./COMMON/chopen.f90 ./EELS/readsp.f90 ./EELS/concat.f90 \
./COMMON/rdhead.f90 ./EELS/calculateweights.f90 ./EELS/angularmesh.f90 \
./EELS/qmesh.f90 ./EELS/euler.f90 ./EELS/productmatvect.f90 \
./EELS/writeangulardependence3.f90 ./EELS/writeangulardependence2.f90 
eels_MODULESRC = \
