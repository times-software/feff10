...
./SFCONV/so2conv.f90 ./SFCONV/ppole.f90 ./SFCONV/croots.f90 \
./SFCONV/qlimits.f90 ./SFCONV/senergies.f90 ./SFCONV/grater.f90 \
./DEBYE/sigms.f90 ./MATH/dist.f90 ./COMMON/pertab.f90 \
./SFCONV/rdeps.f90 ./SFCONV/plset.f90 ./SFCONV/mkrmu.f90 \
./SFCONV/mkspectf.f90 ./SFCONV/mksat.f90 ./SFCONV/interpsf.f90 \
./SFCONV/sfconvsub.f90 ./COMMON/rdhead.f90 
sfconv_MODULESRC = \
