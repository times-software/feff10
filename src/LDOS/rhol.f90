!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! Information about last revision of $RCSfile: rhol.f90,v $:
! $Revision: 1.8 $
! $Author: bmattern $
...
!Changed the dimensions to 40 to account for superheavy elements. Pavlo Baranov 07/2016
  ...
  ! Output
  complex*16, intent(out), dimension(0:lx,nex) :: xrhole
  real*8,     intent(out), dimension(0:lx,nex) :: xrhoce
  complex*16, intent(out) :: ph(nex, lx+1)

  ! Added to satisfy implicit none:
  integer :: lmax,imt,jri,inrm,jnrm,ikap,i0,irr,ic3,i,ilast,ie,ncycle,lll,exlast
  real*8  :: dx05
  ...
  IE_LOOP: do ie = 1, ne
     ...
     LLL_LOOP: do lll=0,lx
		...
		! For Compton, need to wavefunctions out further than for ldos
		exlast = ilast
