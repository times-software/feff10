...
!Changed the dimensions to 40 to account for superheavy elements. Pavlo Baranov 07/2016
      ...
      dimension xnval(41,0:nphx), qnrm(0:nphx) 
...
!     Misc stuff from pot.bin
  ...
  40  format(20(1x,i4))
      ...
      call wrpadd(3, npadx, dgc(1,1,0), 251*41*(nph+1) )
      call wrpadd(3, npadx, dpc(1,1,0), 251*41*(nph+1) )
      call wrpadd(3, npadx, adgc(1,1,0), 10*41*(nph+1) )
      call wrpadd(3, npadx, adpc(1,1,0), 10*41*(nph+1) )
      ...
      call wrpadd(3, npadx, xnval(1,0), 41*(nph+1) )
      call wrpadd(3, npadx, eorb(1), 41)

      do 50 iph=0,nph
        write (3, 60) (iorb(i,iph),i=-5,4)
 50   continue
 60   format(8(1x,i2))
...
!  40  format(20(1x,i4))
      ...
      write(3,*)  dpc0(1:251)
	  write(3,*) 'dgc'
      write(3,*)  dgc(1:251,1:41,0:nph)
	  write(3,*) 'dpc'
      write(3,*)  dpc(1:251,1:41,0:nph)
	  write(3,*) 'adgc'
      write(3,*)  adgc(1:10,1:41,0:nph)
	  write(3,*) 'adpc'
      write(3,*)  adpc(1:10,1:41,0:nph)
	  write(3,*) 'edens'
	  ...
	  write(3,*) 'xnval'
      write(3,*)  xnval(1:41,0:nph)
	  write(3,*) 'eorb'
      write(3,*)  eorb(1:41)

      write(3,*) 'iorb'
      do iph=0,nph
        write (3, 60) iorb(-5:4,iph)
      enddo
 !60   format(8(1x,i2))
	  write(3,*) 'qnrm'
      write(3,*)  qnrm(0:nph)
