...
! FDV: Increasing to avoid issues with converting CIFs to real space for
! certain materials
! integer,parameter :: natx   = 4000    ! Max number of atoms in problem for the pathfinder and ffsort
  integer,parameter :: natx   = 20000    ! Max number of atoms in problem for the pathfinder and ffsort
